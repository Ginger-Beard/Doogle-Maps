...
public enum CropXp
{
	...
	SEAWEED(Seed.SEAWEED, 19.0, 0.0, 21.0),
	MUSHROOM(Seed.MUSHROOM, 61.5, 0.0, 57.7),
	BELLADONNA(Seed.BELLADONNA, 91.0, 0.0, 512.0),
	CALQUAT(Seed.CALQUAT, 129.5, 12096.0, 48.5),
	CELASTRUS(Seed.CELASTRUS, 200.0, 14130.0, 23.5),
	ELKHORN_CORAL(Seed.ELKHORN_CORAL, 20.5, 0.0, 24.0),
	PILLAR_CORAL(Seed.PILLAR_CORAL, 52.0, 0.0, 60.0),
	UMBRAL_CORAL(Seed.UMBRAL_CORAL, 136.0, 0.0, 159.0),
	GRAPE(Seed.GRAPE, 31.5, 625.0, 40.0),
	CRYSTAL_TREE(Seed.CRYSTAL_TREE, 126.0, 13240.0, 0.0),
	ATTAS(Seed.ATTAS, 100.0, 0.0, 0.0),
	IASOR(Seed.IASOR, 100.0, 0.0, 0.0),
	KRONOS(Seed.KRONOS, 100.0, 0.0, 0.0);
